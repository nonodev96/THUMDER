...
export class RegistersView implements OnInit, AfterViewInit {
  ...
  @ViewChild(EditRegisterBinary32Component) public editRegisterBinary32Component: EditRegisterBinary32Component;

  public maxHeightCard: string = "60vh";
  public typeDataSelected: TypeData = "Byte";
  public typeDataSelectedFloat: "Binary" | "Uint8Array" = "Binary";
  public typeDataSelectedDouble: "Binary" | "Uint8Array" = "Binary";
  public displayedColumns = [ "Register", "Hexadecimal", "Binary", "Byte" ];
  ...
  public displayedColumnsR = [ "Register", "Hexadecimal", "Binary", "Integer" ];
  public displayedColumnsF = [ "Register", "Hexadecimal", "Binary" /*Binary or Uint8Array*/, "Float" ];
  public displayedColumnsD = [ "Register", "Hexadecimal", "Binary" /*Binary or Uint8Array*/, "Double" ];
  ...
  public changeTypeDataInTableFloatRegisters(typeData: "Binary" | "Uint8Array") {
    this.typeDataSelectedFloat = typeData;
    this.displayedColumnsF[2] = typeData.toString();
  }

  public changeTypeDataInTableDoubleRegisters(typeData: "Binary" | "Uint8Array") {
